...
import fun.oook.lottery.commons.db.entity.CommonFile;
import fun.oook.lottery.commons.db.entity.CommonFileExample;
...
public interface CommonFileMapper {
    ...
    @ResultMap("fun.oook.lottery.commons.db.mapper.CommonFileMapper.BaseResultMap")
