...
import fun.oook.lottery.commons.db.entity.SysMenuBtn;
import fun.oook.lottery.commons.db.entity.SysMenuBtnExample;
...
public interface SysMenuBtnMapper {
    ...
    @ResultMap("fun.oook.lottery.commons.db.mapper.SysMenuBtnMapper.BaseResultMap")
