...
import fun.oook.lottery.commons.db.entity.SysMenuDatarule;
import fun.oook.lottery.commons.db.entity.SysMenuDataruleExample;
...
public interface SysMenuDataruleMapper {
    ...
    @ResultMap("fun.oook.lottery.commons.db.mapper.SysMenuDataruleMapper.BaseResultMap")
