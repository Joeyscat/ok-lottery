...
import fun.oook.lottery.commons.db.entity.SysRoleBtn;
import fun.oook.lottery.commons.db.entity.SysRoleBtnExample;
...
public interface SysRoleBtnMapper {
    ...
    @ResultMap("fun.oook.lottery.commons.db.mapper.SysRoleBtnMapper.BaseResultMap")
