...
import fun.oook.lottery.commons.db.entity.SysRoleDatarule;
import fun.oook.lottery.commons.db.entity.SysRoleDataruleExample;
...
public interface SysRoleDataruleMapper {
    ...
    @ResultMap("fun.oook.lottery.commons.db.mapper.SysRoleDataruleMapper.BaseResultMap")
