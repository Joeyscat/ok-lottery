...
import fun.oook.lottery.commons.db.entity.TaskBase;
import fun.oook.lottery.commons.db.entity.TaskBaseExample;
...
public interface TaskBaseMapper {
    ...
    @ResultMap("fun.oook.lottery.commons.db.mapper.TaskBaseMapper.ResultMapWithBLOBs")
