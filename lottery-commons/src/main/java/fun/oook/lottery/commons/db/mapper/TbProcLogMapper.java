...
import fun.oook.lottery.commons.db.entity.TbProcLog;
import fun.oook.lottery.commons.db.entity.TbProcLogExample;
...
public interface TbProcLogMapper {
    ...
    @ResultMap("fun.oook.lottery.commons.db.mapper.TbProcLogMapper.BaseResultMap")
