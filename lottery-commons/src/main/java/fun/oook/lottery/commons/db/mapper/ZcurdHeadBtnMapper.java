...
import fun.oook.lottery.commons.db.entity.ZcurdHeadBtn;
import fun.oook.lottery.commons.db.entity.ZcurdHeadBtnExample;
...
public interface ZcurdHeadBtnMapper {
    ...
    @ResultMap("fun.oook.lottery.commons.db.mapper.ZcurdHeadBtnMapper.ResultMapWithBLOBs")
