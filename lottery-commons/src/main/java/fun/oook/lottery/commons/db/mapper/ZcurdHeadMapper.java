...
import fun.oook.lottery.commons.db.entity.ZcurdHead;
import fun.oook.lottery.commons.db.entity.ZcurdHeadExample;
...
public interface ZcurdHeadMapper {
    ...
    @ResultMap("fun.oook.lottery.commons.db.mapper.ZcurdHeadMapper.BaseResultMap")
